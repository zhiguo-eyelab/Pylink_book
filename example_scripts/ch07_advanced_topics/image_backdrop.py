...
tk.bitmapBackdrop(w, h, pixels_img, 0, 0, w, h, 0, 0, pylink.BX_MAXCONTRAST)
...
# Show the checkboard for 1-sec on the Host PC
pylink.msecDelay(1000)

# Transfer the checkboard constructed with RGB tuples to the Host
tk.sendCommand('clear_screen 0')
tk.bitmapBackdrop(6, 6, pixels_rgb, 0, 0, 6, 6, 0, 0, pylink.BX_MAXCONTRAST)
tk.bitmapSaveAndBackdrop(6, 6, pixels_rgb, 0, 0, 6, 6, 'trial_image', 'img',
                         pylink.SV_MAKEPATH, 300, 300, pylink.BX_MAXCONTRAST)
